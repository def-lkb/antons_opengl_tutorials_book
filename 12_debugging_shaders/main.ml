...
let load_texture unit filename = match Stb_image.load ~channels:4 filename with
...
let main () =
  ...
  let point_count, vp, vt, vn = Obj_parser.load_obj_file "suzanne.fobj" in
  ...
  Gl.buffer_data Gl.array_buffer (3 * point_count * 4) (Some vn) Gl.static_draw;
  ...
  Gl.buffer_data Gl.array_buffer (2 * point_count * 4) (Some vt) Gl.static_draw;
  ...
  let diffuse_map = Gl.get_uniform_location shader_program "diffuse_map" in
  let specular_map = Gl.get_uniform_location shader_program "specular_map" in
  let ambient_map = Gl.get_uniform_location shader_program "ambient_map" in
  let emission_map = Gl.get_uniform_location shader_program "emission_map" in

  let _tex_diff  = load_texture Gl.texture0 "boulder_diff.png" in
  let _tex_spec  = load_texture Gl.texture1 "boulder_spec.png" in
  let _tex_amb   = load_texture Gl.texture2 "ao.png" in
  let _tex_emiss = load_texture Gl.texture3 "tileable9b_emiss.png" in
  ...
  Gl.uniform1i diffuse_map  0;
  Gl.uniform1i specular_map 1;
  Gl.uniform1i ambient_map  2;
  Gl.uniform1i emission_map 3;
