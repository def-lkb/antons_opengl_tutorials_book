...
let main () =
  ...
  let tex_a_location = Gl.get_uniform_location shader_program "basic_texture" in
  assert (tex_a_location > -1);
  let tex_b_location = Gl.get_uniform_location shader_program "second_texture" in
  ...
  let tex_a = load_texture "skulluvmap.png" in
  Gl.bind_texture Gl.texture_2d tex_a;
  Gl.active_texture Gl.texture1;
  let tex_b = load_texture "ship.png" in
