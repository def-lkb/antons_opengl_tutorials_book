...
let main () =
  ...
  (*----------------------------create geometry-----------------------------*)
  let point_count, vao = load_mesh "monkey.fobj" in
  Gl.bind_vertex_array vao;
  ...
  let _tex_diff  = load_texture "boulder_diff.png" in
  Gl.active_texture Gl.texture1;
  let _tex_spec  = load_texture "boulder_spec.png" in
  Gl.active_texture Gl.texture2;
  let _tex_amb   = load_texture "ao.png" in
  Gl.active_texture Gl.texture3;
  let _tex_emiss = load_texture "tileable9b_emiss.png" in
