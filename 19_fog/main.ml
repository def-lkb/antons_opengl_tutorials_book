...
let main () =
  ...
  let time_location = Gl.get_uniform_location shader_program "time" in
  ...
  let seconds_0 = Unix.gettimeofday () in
  ...
  let rec loop () =
    ...
    if is_done then ()
      ...
      begin
        ...
        Gl.use_program shader_program;
        Gl.uniform1f time_location (current_seconds -. seconds_0);
